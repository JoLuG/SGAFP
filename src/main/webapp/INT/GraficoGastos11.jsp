<%-- 
    Document   : GraficoGastos11
    Created on : 11/06/2023, 06:00:59 PM
    Author     : wendy
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../CSS/Gastos-Estilo-ALL11.css">
        <title>Gastos</title>    
    </head>
    <body>
        <%
        ...
        <div class="Cuadro-blanco">
            ...
            <div class="div-derecho">                            
                <br>
                <center>
                    <span class="h1-titulo">Otros</span>
                </center> 
                ...
                <center>     
                    <table class="tb-btn-img1">
                        <tr>
                            ...
                            <td>
                                <a href="GraficoGastos11.jsp?usuario=<%=us.getUsuario()%>&&tgasto=<%=categoria%>" class="a-btn-img"><i title="Grafico" class="fa-solid fa-chart-column icon-menu1"></i></a>
                            </td>                         
                    ...
                    <table class="tb-info-ingresos">
                        ...
                        <tbody>
                            ...
                            <tr class="tr-tbody">
                                ...
                                <td class="td-op-tbody"><a href="modificar-gasto11.jsp?usuario=<%=us.getUsuario()%>&&id=<%=in.get(i).getIdgastos()%>&&tgasto=<%=categoria%>" class="a-btn-img"><i title="Modificar" class="fas fa-edit icon-menu2"></i></a></td>                                
        ...
        <div class="overlay">
            <div class="popup-graficos">
                ...
                <center>
                    <a href="GastoOtros.jsp?usuario=<%=us.getUsuario()%>&&tgasto=<%=categoria%>" class="a-exit-graficos"><i title="Salir" class="fas fa-times"></i></a>
                    <br><br>
                    <span style="color: #808000; font-weight: bold; font-size: 20pt">
                        Grafico Otros
                    </span>
                    <br><br>
