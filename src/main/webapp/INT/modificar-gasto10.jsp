<%-- 
    Document   : modificar-gasto10
    Created on : 11/06/2023, 05:11:26 PM
    Author     : wendy
--%>
    ...
    <body>
        ...
        <div class="overlay">
            <div class="popup">
                ...
                %>
                <center>
                    <a href="GastoDeudas.jsp?usuario=<%=us.getUsuario()%>&&tgasto=<%=categoria%>" class="a-exit-ing"><i title="Salir" class="fas fa-times"></i></a>
                    <br><br>
